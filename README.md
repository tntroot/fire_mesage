# 滅火器管理系統
採用原生 JavaScript、HTML、CSS 的滅火器管理系統
## 使用技術
1. HTML5/CSS3
2. JavaScript
3. PHP
...
<p align="center"><img src="Screenshots/image.png" width="600"></img></p>
▲ 滅火器選單頁，提供使用者在各項功能中進行切換

&nbsp;

<p align="center"><img src="Screenshots/image3.png" width="300" height="150"></img></p>
▲ 滅火器資訊頁，系統會顯示 30 天內即將過期的滅火器數量以及尚未完成維修的滅火器數量

&nbsp;

<p align="center"><img src="Screenshots/image4.png" width="600" ></img></p>
▲ 查詢閒置固定架頁，透過選單列進入後即可直接查詢，可在位置的下拉選單中選擇目標大樓，系統將會根據要求提供目標大樓內的閒置固定架資訊

&nbsp;

<p align="center"><img src="Screenshots/image5.png" width="600" ></img></p>
▲ 查詢廢棄固定架頁，透過上方的閒置/廢棄按鈕進行切換，進入後可以知道過去廢棄的固定架資訊

&nbsp;

<p align="center"><img src="Screenshots/image6.png" width="600" ></img></p>
▲ 在查詢功能中勾選需要上傳資料並按下上傳，即可上傳至手機，上傳完成後會傳送成功資訊通知使用者

&nbsp;

<p align="center"><img src="Screenshots/image7.png" width="600" ></img></p>
▲ 在查詢功能中勾選需要列印的目標再點選列印即可進行列印

&nbsp;

<p align="center" style="display: flex;"><img src="Screenshots/image8.png" width="200"></img>
&nbsp;
<img src="Screenshots/image9.png" width="200"></img></p>
▲ 點選新增功能後可以選擇要新增的是滅火器廠商或是藥粉廠商，再輸入資料後系統將會跳出確認視窗讓使用者進行二次確認

&nbsp;

<p align="center"><img src="Screenshots/image10.png" width="200" ></img></p>
